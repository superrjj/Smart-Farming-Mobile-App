      ...
      <ScrollView
        ...
        <View style={styles.card}>
          <TouchableOpacity
            ...
            onPress={() => router.push({ pathname: '/UserManagement/farmerProfile', params: { email } })}>
          ...
          <TouchableOpacity
            style={styles.menuRow}
            onPress={() => router.push({ pathname: '/UserManagement/waterRequirement', params: { email } })}>
            <FontAwesome name="cog" size={20} color={colors.primary} />
            <Text style={styles.menuLabel}>Water Requirements</Text>
            <FontAwesome name="chevron-right" size={14} color={colors.grayText} />
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.menuRow}
            onPress={() => router.push({ pathname: '/UserManagement/sensorDevice', params: { email } })}>
